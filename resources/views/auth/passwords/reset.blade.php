                ...
                <div class="text-start">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="email" type="email" class="py-2 mt-1 block w-full border-gray-300 rounded-md shadow-sm @error('email') is-invalid @enderror"
                        ...
                        <div class="mb-4">
                            ...
                            <input id="password" type="password" class="py-2 mt-1 block w-full border-gray-300 rounded-md shadow-sm @error('password') is-invalid @enderror"
                        ...
                        <div class="mb-4">
                            ...
                            <input id="password-confirm" type="password" class="py-2 mt-1 block w-full border-gray-300 rounded-md shadow-sm"
